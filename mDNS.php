...
class mDNS
{
    ...
    public function __construct()
    {
        ...
        socket_bind($this->mdnssocket, "0.0.0.0", 5353);
    }
    ...
    public function query($name, $qclass, $qtype, $data = "")
    {
        ...
        socket_sendto($this->mdnssocket, $data, strlen($data), 0, '224.0.0.251', 5353);
    }

    public function requery()
    {
        socket_sendto($this->mdnssocket, $this->querycache, strlen($this->querycache), 0, '224.0.0.251', 5353);
    }
